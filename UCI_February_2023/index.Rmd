---
title: "Nonbacktracking Eigenvector Method for Hypergraph Community Detection"                 
subtitle: "<br> Combinatorics and Probability Seminar<br>February 22nd, 2023"
...
# xaringan::inf_mr("UCI_February_2023/index.rmd")
```
...
.column[.lil-stretch[<br><br><br><br><br><br><br><br>
  .alert[Phil Chodrow] <br> UCLA @PhilChodrow
  ]]
.column[.lil-stretch[<br><br><br><br><br><br><br><br>
...
Philip S. Chodrow, Nicole Eikmeier, and **JH** (2022). Nonbacktracking spectral clustering of nonuniform hypergraphs. *SIMODS, to appear*. (arXiv: 2204.13586)
...
<br> <br>
  ...
  .footnote[
  One review in: <br> P. S. Chodrow, N. Veldt, A. R. Benson (2021). Generative hypergraph clustering: from blockmodels to modularity, <i>Science Advances</i>, 7:eabh1303
]
...
<br> 
<b>Can represent hyperedges of all sizes in the same matrix!</b>
...
.column.bg-main2[
### The Nonbacktracking Operator in Data Science

<br> 
Used for graph community detection by Krzakala, F. et al. (2013) *PNAS*.

Used for hypergraph community detection by Angelini, M. C. et al. (2015), *Allerton Conference*.

Applications of nonbacktracking random walks: PageRank in Arrigo, F. et al. (2019) *J. Sci. Comp.* and centrality in Arrigo, F. et al. (2017) *IMA J. Comp. Net.*

Spectral algorithm (with guarantees) provided by Stephan and Zhu (2022) *FOCS 2022*.
...
Philip S. Chodrow, Nicole Eikmeier, and **JH** (2022). Nonbacktracking spectral clustering of nonuniform hypergraphs. *In preparation*.

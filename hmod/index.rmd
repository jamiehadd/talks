...
#### We propose a heterogeneous **hypergraph degree-corrected stochastic blockmodel**.
...
.midi[
Example: $\mathbf{z}_R = (\color{#F5B895}{\bullet}, \color{#0F4C81}{\bullet}, \color{#0F4C81}{\bullet}, \color{#0F4C81}{\bullet},  \color{#F4DBB3}{\bullet}, \color{#F4DBB3}{\bullet})$, $\mathbf{p} = (3, 2, 1)$. 
]

...
subtitle: "NCSU Applied Mathematics Seminar<br>September 13, 2022"
...
# xaringan::inf_mr("NCSU_September_2022/index.rmd")
```
...
**JH**, Benjamin Jarman, and Chen Yap (2022). Paving the Way for Consensus: Convergence of Block Gossip Algorithms. *IEEE Transactions on Information Theory, to appear, 2022*.

.row[ 
.column[.lil-stretch[<br>
  <img src="img/Hector.jpg" width=30%> 
  ]]
]]
.row[ 
.column[.lil-stretch[

...
subtitle: "Department of Mathematics and Statistics, Swarthmore College<br>January 24th, 2021"
author: "Dr. <span class = 'author-highlight'>Phil Chodrow</span> <br> Department of Mathematics, UCLA "           
date: ""              
output:                         
...
class: bg-main1 
background-image: url("img/geo-intro.png")
...
.font_smaller[
<br> 
.alert[**Fact**]: Top two eigenpairs of $\mathbf{A}$ are close to these with high probability as $n$ grows large.  
]
...
.footnote[
  Result argued heuristically by <br>

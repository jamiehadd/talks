...
subtitle: ""
author: "Phil Chodrow <br>Department of Mathematics, UCLA"
date: ""
output:
...
## *In a degree-preserving random graph, what is the* ***expected number of edges*** *between a node of degree $d_i$ and a node of degree $d_j$?*
...
.white-bg[
# .midi[Modularity]
An objective function for graph clustering (terms and conditions apply). 
...
.footnote[Newman + Girvan, "Finding and Evaluating Community Structure in Networks." *PRE*, (2004) (14K citations on Google Scholar)]
...
.footnote[Newman + Girvan, "Finding and Evaluating Community Structure in Networks." *PRE*, (2004) (14K citations)]
...
.embolden[Theorem]<sup>1</sup>: This successfully (but **slowly**) samples from $\eta_\mathbf{d}$. 
...
1. The Jacobian $\mathbf{J}$ of $\mathbf{h}$ has strictly positive eigenvalues on $\mathcal{B}$.
2. The Hessian $\mathcal{H}$ of $\mathcal{L}$ is positive-definite at all critical points of $\mathcal{L}$ $\implies$ all critical points are isolated local minima. 

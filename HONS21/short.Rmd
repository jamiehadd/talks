...
**Theorem [PC, JH, NE 2021] (Ihara-Determinant Formula)**: Under mild restrictions, the "interesting" eigenvalues of $\mathbf{B} \in \mathbb{R}^{m\langle k\rangle \times m\langle k\rangle}$ coincide with the eigenvalues of the matrix 

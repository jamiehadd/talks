...
- Take some time for a [self-assessment ](http://www.cpedv.org/sites/main/files/oppression_and_privilege_self_assessment.pdf). 
...
.column.bg-main1[<br>
.content.font_large[.font_large[**Questions** for STEM Careers]]

.font_large[<br>  ]

.font_large[What, *really*, am I making or studying?]

.font_large[**Who benefits** from my product or research? Who is .alert2[included], and who is .alert[excluded] or .alert[oppressed] by my work?]

.font_large[What identities are .alert2[present] in my workplace or program? What identities are .alert[absent]? What about in **leadership roles**?]

.font_large[Does my interpersonal presence (collaboration, leadership, teaching) .alert2[actively welcome] all identities to share in scholarship? Whom does it .alert[quietly exclude]?]
]

.column[<br>
.content.font_large[.font_large[What can you do **today**?]]
  
.font_large[<br>  ]

.font_large[Self-assessments (links on previous slide).]

<br> 

.font_large[.font_large[Challenge]]

.blockquote[.font_large[Identify **two** identity groups that you see underrepresented in your major. For each: 

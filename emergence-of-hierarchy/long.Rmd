...
.alert2[Competitions] (chess, basketball...): 

> - Nodes are competitors. 
<br>
> - $A\rightarrow B$ $\implies$ $B$ beat $A$. 

The .alert2[Internet] (Google, Facebook...): 

> - Nodes are webpages. 
> - $A\rightarrow B$ $\implies$ $A$ links to $B$. 


.alert2[Endorsements] (politics, Twitter...):  
  
> - Nodes are people. 
> - $A\rightarrow B$ $\implies$ $A$ thinks $B$ is good. 

...
This function $\mathbf{f}$ has an egalitarian fixed point such that $\mathbf{r} = r \mathbb{e}$. The egalitarian fixed point is linearly stable if $\beta_1 < \beta_1^c$, where 
...
.color-main1[tab] (*m* is the number of endorsements per timestep, *n* is the number of nodes) 
]
.column.bg-main4[.content.vmiddle[
<img src="img/dynamics_examples.png" width=100%> 
]]

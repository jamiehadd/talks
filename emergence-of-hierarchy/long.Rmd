...
.font_large[Things I .alert[like]:
...
.column[
<img src="../img-shared/cartoon-avatar-no-bg.png" width=100%>
...
- ...2nd generation academic (father was a physicist).
...
- What is your [social identity](https://sites.lsa.umich.edu/inclusive-teaching/wp-content/uploads/sites/732/2020/07/Social-Identity-WheelDefinitions.pdf)? 

## What role do oppression and privilege play in your journey?

- Take some time to [assess your privilege](http://www.cpedv.org/sites/main/files/oppression_and_privilege_self_assessment.pdf). 
...
.column.bg-main1[
.content.font_large[.font_large[Questions in .alert[Industry]]]

.font_large[<br> <br> <br> ]

.font_large[What, *really*, am I making?]

.font_large[**Who benefits** from my work? Who is .alert2[included], and who is .alert[excluded] or .alert[oppressed] by what I produce?]

.font_large[Does my product .alert[reinforce] existing inequities, or will it .alert2[break them down]?]

.font_large[What identities are .alert2[present] in my workplace? What identities are .alert[absent]? What about in **leadership roles**?]

]

.column[
.content.font_large[.font_large[Questions in .alert2[Grad School]/.alert2[Academia]]]

.font_large[<br> <br> <br> ]

.font_large[What, *really*, am I studying?]


.font_large[**Who benefits** from my research? Who is .alert2[included], and who is .alert[excluded] or .alert[oppressed] by what I produce?]

.font_large[Does my teaching .alert2[actively welcome] all identities to share in scholarship? Does it .alert[quietly exclude] anyone?]

.font_large[What identities are .alert2[present] in my program? What identities are .alert[absent]? What about in **leadership roles**?]
]
...
# *How can we work together to to make STEM a more .alert[**just**] and .alert[**inclusive**] social endeavor?*
...
\frac{\partial f_2}{\partial r_1} & \frac{\partial f_2}{\partial r_2} & \cdots  & \frac{\partial f_2}{\partial r_b} \\ 
...
Checking for stability conditions is a long linear algebra exercise...
...
\end{cases}$$
<br> <br> 
Math PhD exchange is .alert2[**barely subcritical**]. 
...
.column.bg-main1[
<br>
# Tips for ~~Interdisciplinary Applied Math~~ Life
...
Brush up on your .alert[linear algebra].

...
.column[.image-caption-right[
  ...
  .font_medium[Applied and Computational Mathematics <br> Princeton University <br> .alert2[MS144, 3:00pm-3:25pm]]
  ]    
]
.column[.image-bottom[
...
We propose a simple .alert[math model] of hierarchies emerging from feedback loops.
...
This function has an egalitarian root such that $\mathbf{r} = r \mathbb{e}$. This root is .alert[linearly stable] iff $\beta_1 < \beta_1^c$: 
...
https://philchodrow.github.io/talks/emergence-of-hierarchy/short#1

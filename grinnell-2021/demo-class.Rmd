...
author: "Dr. <span class = 'author-highlight'>Phil Chodrow</span> <br> UCLA <br> November 19th, 2021"           
date: ""              
output:                         
...
...You will be able to conceptually describe the .alert[algorithm] in the phrase "machine learning algorithm."

...You will have proven **correctness** and **convergence** rates for simple optimization examples. 

...You will have analyzed an instance of .alert2[algorithmic bias] from an optimization perspective. 
...
Given a function $y = f(x)$, find the *minimum* $x_*$ where $f(x_*)$ is smallest on some interval. 
...
So, we need *algorithms* to find the minimum.  
...
*In order to ensure*  $|x_t - x_*| < \epsilon$, *I need to do  $t \in O(g(\epsilon))$ iterations of my optimization algorithm.*  
]

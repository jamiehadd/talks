...
It is "easy to verify" that if all all clusters have the same average degree (number of edges), BP has a fixed point that contains no info about the clusters. 
...
The .alert[Hashimoto operator] lets us use eigenvector techniques for community detection in hypergraphs. 

...
1. Interpreting measurements in network science often requires **null random graph modeling.**
...
4. Careful solutions to these problems can alter our perspectives on existing questions, and pose new ones. 
...
1. .embolden["Configuration Models of Random Hypergraphs."] Mostly about **relevance** in the context of polyadic data. 
2. .embolden["Moments of Uniformly Random Multigraphs with Fixed Degree Sequences."] Mostly about .highlight[tractability] in the context of dyadic data. 
...
.large[**Let's do some data science.**]
...
"Among all pairs of edges of sizes $k$ and $\ell$, what proportion have intersection of size $j$?"
...
**Theorem:**<sup>*</sup> With high probability, 
...
.footnote[<sup>*</sup>Terms and conditions apply.]
---
...
4. So, $\exists$ at most one local minimizer of $\mathcal{L}$. 
]

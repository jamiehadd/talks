...
subtitle: "Department of Mathematics and Statistics<br> Swarthmore College<br>January 24th, 2022"
...
.center[
  <img src="img/pol-blogs.png" width=55%>
]
.footnote[
  Image from <a href="http://allthingsgraphed.com/2014/10/09/visualizing-political-polarization/"> All Things Graphed </a> 
  ]
...
.column[
  ...
  .center[
  <br> 
  <img src="img/sample-matrix.png" width=95%>
  ]
...
Define $(e_1, v_1) \rightarrow (e_2, v_2)$ as: 
...
.column.bg-main1[
  ...
  <br> 
  Models of .alert[edge-correlations] in hypergraphs. 
...
.content[
#### Models of Biosocial Systems <br><br>
  .font_smaller[.font_smaller[
Comparing network ranking functions with actual, .alert[human-attributed ranks] 
- Ongoing collab with social anthropologists.

Statistical problems with .alert[inference of social hierarchies] (focal sampling, behavior categories).
  ]
]
]
  ]
...
class: hide-col1 hide-col2 hide-col3

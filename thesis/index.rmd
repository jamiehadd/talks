...
# .midi[Messages for Today (or, what I learned in my PhD)]

.large[
.yellow-bg[
\#MethodsMatter in network science.
]
.blue-bg[
...
.alert[
.embolden[Theorem] (PSC 2020): Solution (if it exists) is unique on the set 
